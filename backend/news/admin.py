...
class NewsSourceAdmin(admin.ModelAdmin):
    list_display = ("name", "url", "is_active", "search_news", "search_calendars", "search_tables", "last_fetched_at")
    list_filter = ("is_active", "search_news", "search_calendars", "search_tables")
...
class SourceDiscoveryAdmin(admin.ModelAdmin):
    list_display = ("title", "source", "discovery_type", "is_imported", "show_on_main_page", "updated_at")
    list_filter = ("discovery_type", "is_imported", "show_on_main_page", "source")
